    ...
    return (
        <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
            <div className="shadow-sm">
                <div className="relative flex w-full items-center bg-[#232F4B] px-5 py-2.5">
                    <div className="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                        <img src="/assets/icons/B_Black.svg" alt="GemText Logo" className="w-8 h-8" />
                            <span className="hidden align-middle text-2xl  font-semibold  transition-all duration-300 ltr:ml-1.5 rtl:mr-1.5 text-white md:inline">GemText Ai</span>
                        </Link>
                        <button
                            type="button"
                        ...
                        <div className="sm:ltr:mr-auto sm:rtl:ml-auto">
                            ...
                            >
                                <div className="relative">
                                    <input
                                        type="text"
                                        className="w-full h-9 pl-8 pr-3 py-1.5 rounded-lg bg-white text-[#232B44] placeholder:text-[#7B88A8] placeholder:font-normal placeholder:text-base border-none shadow-sm focus:ring-2 focus:ring-[#232B44] outline-none"
                                        placeholder="Search..."
                                    />
                            ...
                            <button
                                ...
                                className="search_btn rounded-full bg-white p-2 hover:bg-gray-100 text-[#232F4B] sm:hidden"
                            >
                                <IconSearch className="mx-auto h-4.5 w-4.5" />
                            </button>
                        </div>
                        {/* Removed theme toggle buttons here */}
                        ...
                        <div className="dropdown flex shrink-0">
                            ...
                            >
                                <ul className="w-[230px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                                    ...
                                    <li>
                                        <Link href="/organization" className="dark:hover:text-white">
